...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.OneSignal.EmailUpdateHandler, Com.OneSignal, Version=3.0.1.0, Culture=neutral, PublicKeyToken=null", EmailUpdateHandler.class, __md_methods);
	}
	...
	public EmailUpdateHandler ()
	{
		...
		if (getClass () == EmailUpdateHandler.class)
			mono.android.TypeManager.Activate ("Com.OneSignal.EmailUpdateHandler, Com.OneSignal, Version=3.0.1.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
